      ...
      <main className="flex-1 overflow-hidden flex max-w-7xl mx-auto w-full">
        ...
        <div className="flex-1 overflow-y-auto bg-white p-4">
            ...
            <div className="max-w-3xl mx-auto space-y-3">
              <div className="bg-white rounded-xl border border-indigo-100 p-3">
                ...
                <form onSubmit={handleAddAdminEmp} className="p-2.5 bg-gray-50 border border-gray-200 rounded-lg space-y-1.5">
                  ...
                  <button type="submit" className="w-full py-1.5 bg-brand-600 hover:bg-blue-700 text-white text-xs font-semibold rounded-lg">Add</button>
                </form>
                    ...
                    editingEmpId===e.empid ? (
                      <form key={e.empid} onSubmit={handleSaveEditEmp} className="p-2 bg-amber-50 flex flex-col gap-1">
                        ...
                        <div className="flex gap-1">
                          ...
                          <button type="submit" className="flex-1 py-1 bg-brand-600 hover:bg-blue-700 text-white rounded text-xs">Save</button>
                        </div>
                      </form>
                    ) : (
            ...
            <div className="max-w-4xl mx-auto space-y-4">
              ...
              <div className="bg-white rounded-xl border border-indigo-100 p-4 shadow-sm">
                ...
                <form onSubmit={handleCreate} className="space-y-2">
                  ...
                  <button type="submit" className="w-full px-3 py-1.5 bg-brand-600 hover:bg-blue-700 text-white text-xs font-medium rounded-lg flex items-center justify-center gap-1.5"><Plus size={12}/> Create User</button>
                </form>
              </div>
          ...
          {adminTab === 'shifts' && (
            <div className="max-w-3xl mx-auto space-y-3">
              <div className="bg-white rounded-xl border border-indigo-100 p-4 shadow-sm">
                <h2 className="text-xs font-bold text-indigo-800 mb-3 flex items-center gap-2"><Clock size={14} className="text-indigo-600"/> Shift Management</h2>
