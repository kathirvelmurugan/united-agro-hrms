...
export default function LoginPage({ onLogin }: LoginPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center p-4">
      ...
      >
        <div className="md:w-5/12 bg-gradient-to-br from-brand-600 to-brand-800 p-8 flex flex-col items-center justify-center text-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-10">
            <svg width="100%" height="100%" viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
              <circle cx="30" cy="30" r="80" fill="white" />
              <circle cx="170" cy="50" r="100" fill="white" />
              <circle cx="50" cy="180" r="70" fill="white" />
              <circle cx="180" cy="170" r="60" fill="white" />
            </svg>
          </div>
          <motion.div
            initial={{ scale: 0 }}
          ...
          >
            <p className="text-lg font-bold text-white tracking-wide">Biometric</p>
            <p className="text-lg font-bold text-white/90 -mt-1">Attendance System</p>
          </motion.div>
        </div>

        <div className="md:w-7/12 p-8 md:p-10">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-900">UA Attendance</h1>
            <p className="text-sm text-gray-500 mt-1">Sign in to view employee attendance</p>
          </div>

          <form onSubmit={handleSubmit} autoComplete="off" className="space-y-4 max-w-sm mx-auto">
            ...
            <div>
              ...
              <input
                ...
                autoComplete="off"
                required
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 transition-all"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-2.5 bg-brand-600 hover:bg-brand-700 text-white font-medium rounded-lg text-sm transition-colors flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              <LogIn size={16} />
